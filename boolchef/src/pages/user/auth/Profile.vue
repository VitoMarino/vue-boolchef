...
<template>
    ...
    <div class="form-width d-flex justify-content-center">
        <form @submit.prevent="submitForm">
            <!--Address-->
            <div class="mb-3">
                <label for="address" class="form-label">Indirizzo</label>
                <input type="text" class="form-control" name="address" v-model="form.address" id="address"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="telephone" v-model="form.telephone" id="telephone"
                    aria-describedby="emailHelp">
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control mb-3" name="description_of_dishes" v-model="form.description_of_dishes"
                    id="description_of_dishes"></textarea>
            </div>

            <!--Foto profilo-->
            <div class="mb-3">
                <label for="photograph" class="form-label">Carica foto profilo</label>
                <input class="form-control mb-3" type="file" name="photograph" id="photograph"
                    @change="prendiFileUpload($event, 'CV')">
            </div>
            ...
            <div>
                ...
                <select class="form-select mb-3" aria-label="Default select example" name="visibility"
                    v-model="form.visibility" id="visibility">
                    <option value="0">
                        Non visibile
                    </option>
                    <option value="1">
            ...
            <div>
                ...
                <div class="d-flex flex-wrap" role="group" aria-label="Basic checkbox toggle button group">
                    <div v-for="(specialization, index) in specializationsList" :key="specialization.id">
                        <input type="checkbox" name="specializations[]" :id="specialization + specialization.id"
                            v-model="form.specializations" class="btn-check" autocomplete="off">
